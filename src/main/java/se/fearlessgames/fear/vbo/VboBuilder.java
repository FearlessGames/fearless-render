...
public class VboBuilder {
    ...
    public static VboBuilder fromBuffer(FloatBuffer vertices) {
        return new VboBuilder(vertices.duplicate());
    }
    ...
    public VertexBufferObject build() {
        ...
        VertexBufferObject.InterleavedBuffer interleavedBuffer = new VertexBufferObject.InterleavedBuffer(buffer, normalsSize != 0, colorsSize != 0, texturesSize != 0);
        ...
        return new VertexBufferObject(interleavedBuffer, indices, drawMode);
    }
